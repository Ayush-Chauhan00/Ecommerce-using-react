...
function DashboardTab() {
  ...
  const { mode, product, deleteProduct, editProduct } = context
                              ...
                              <div className=" flex gap-2 cursor-pointer text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                ...
                                <Link to={'/updateProduct'}>
                                  <div onClick={() => editProduct(item)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" onClick={() => editProduct(item)}>
